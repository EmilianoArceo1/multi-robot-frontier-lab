"""PolicyNet supplied by the MARVEL authors, adapted only for packaging.

Source: https://github.com/marmotlab/MARVEL, ``utils/model.py``.
The layer names and tensor shapes are intentionally unchanged so the official
``checkpoint['policy_model']`` state dictionary loads without key remapping.
"""
