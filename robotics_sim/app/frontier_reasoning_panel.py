...
class FrontierReasoningPanel(QFrame):
    ...
    def _render_coordination(self, robot_index: int) -> None:
        ...
        coordinator_owns_generation = bool(
            getattr(runtime_profile, "owns_target_generation", False)
        )
        self.summary.setText(
        ...
        if selected_dict is None:
            ...
            self.formula.setText(
                "<b>Fᵢ* is generated by the active coordinator plugin.</b><br>"
            ...
            self.procedure.setText(
                f"1. {html.escape(str(coordinator))} generated or requested candidates.<br>"
                f"2. It selected the proposal for R{robot_index + 1}.<br>"
