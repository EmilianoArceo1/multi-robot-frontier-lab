...
def snapshot_row(
    ...
    row = {
        ...
        "frontier_configured_planner": _maybe_value(frontier.configured_planner),
        "frontier_effective_planner": _maybe_value(frontier.effective_planner),
        "frontier_attempt_role": _maybe_value(frontier.attempt_role),
